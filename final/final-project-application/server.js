...
app.get('/session/sightSeeing', (req, res) => {
  const response = {
...
app.get('/session/culture', (req, res) => {
  const response = {
...
app.get('/session/family', (req, res) => {
  const response = {
...
app.get('/session/shopping', (req, res) => {
  const response = {
...
app.get('/session/sports', (req, res) => {
  const response = {
...
app.get('/session/cruiseinfo', (req, res) => {
  const response = {
...
app.get('/session/restaurants', (req, res) => {
  const response = {
...
app.get('/session/coffee', (req, res) => {
  const response = {
...
app.get('/session/spirits', (req, res) => {
  const response = {
...
app.get('/session/hotel', (req, res) => {
  const response = {
    message : 'hotel info'};
    res.status(200).json(response);
});

app.get('/session/blog', (req, res) => {
  const response = {
    message : 'blog info'};
    res.status(200).json(response);
});
